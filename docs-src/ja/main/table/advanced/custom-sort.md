 ...
 * ユーザーは onSortChange イベントでテーブルprops 'dataSource' を更新して排序を完了できます。
 *
 ...
 * @param sortConfig SortConfig参照 https://github.com/ja-plus/stk-table-react/blob/master/src/StkTable/types/index.ts
