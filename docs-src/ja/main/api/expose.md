 ...
 * @param {boolean} option.silent `onCurrentChange` をトリガーしないようにtrueに設定。デフォルト: false
 ...
 * @param col 列オブジェクト
 * @param option.silent `onCurrentChange` をトリガーさないようにtrueに設定。デフォルト: false
 */
 ...
 * @param data.silent `onToggleRowExpand` をトリガーしないようにtrueに設定。デフォルト: false
 */
 ...
 * ドラッグ選択範囲を設定
 * @param ranges 選択範囲配列
 * @param option.silent trueに設定すると `onAreaSelectionChange` をトリガーしません。デフォルト: false
 ...
 * @param option.silent true に設定すると `onFilterChange` イベントをトリガーしません、デフォルト false
 */
