 ...
 * @param {boolean} option.silent true로 설정하면 `onCurrentChange` 트리거 안함. 기본값:false
 ...
 * @param col 열 객체
 * @param option.silent true로 설정하면 `onCurrentChange` 트리거 안함. 기본값:false
 */
 ...
 * @param data.silent true 설정 시 `onToggleRowExpand` 트리거 안함. 기본값:false
 */
 ...
 * @param option.silent true 설정 시 `onAreaSelectionChange` 트리거 안함. 기본값:false
 ...
 * @param option.silent true 설정 시 `onFilterChange` 이벤트를 트리거하지 않습니다, 기본값 false
 */
