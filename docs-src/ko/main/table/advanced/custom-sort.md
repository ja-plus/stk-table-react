 ...
 * 사용자가 onSortChange 이벤트에서 table props 'dataSource'를 직접 변경하여 정렬을 완료합니다.
 *
 ...
 * @param sortConfig SortConfig참고 https://github.com/ja-plus/stk-table-react/blob/master/src/StkTable/types/index.ts
