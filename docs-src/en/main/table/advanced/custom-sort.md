...
```
<demo react="advanced/custom-sort/CustomSort/index.tsx" github="https://github.com/ja-plus/stk-table-react/tree/master/docs-demo/advanced/custom-sort/CustomSort/index.tsx"></demo>
...
```ts
import { tableSort, insertToOrderedArray } from 'stk-table-react';
```
### tableSort
#### Usage Scenario
 ...
 * Users can update the table props 'dataSource' in the onSortChange event to complete sorting.
 *
 ...
 * @param sortConfig SortConfig reference https://github.com/ja-plus/stk-table-react/blob/master/src/StkTable/types/index.ts
...
<demo react="advanced/custom-sort/InsertSort.tsx" github="https://github.com/ja-plus/stk-table-react/tree/master/docs-demo/advanced/custom-sort/InsertSort.tsx"></demo>
