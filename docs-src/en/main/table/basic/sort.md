...
<demo react="basic/sort/Sort.tsx" github="https://github.com/ja-plus/stk-table-react/tree/master/docs-demo/basic/sort/Sort.tsx"></demo>
...
<demo react="basic/sort/CustomSort.tsx" github="https://github.com/ja-plus/stk-table-react/tree/master/docs-demo/basic/sort/CustomSort.tsx"></demo>
...
<demo react="basic/sort/SortField.tsx" github="https://github.com/ja-plus/stk-table-react/tree/master/docs-demo/basic/sort/SortField.tsx"></demo>
...
```
<demo react="basic/sort/SortEmptyValue.tsx" github="https://github.com/ja-plus/stk-table-react/tree/master/docs-demo/basic/sort/SortEmptyValue.tsx"></demo>
...
:::
<demo react="basic/sort/DefaultSort.tsx" github="https://github.com/ja-plus/stk-table-react/tree/master/docs-demo/basic/sort/DefaultSort.tsx"></demo>
...
After clicking the table header, the `onSortChange` event will be triggered. You can initiate an ajax request in the event, then reassign `props.dataSource` to complete the sorting.

```tsx
<StkTable sortRemote />
```
<demo react="basic/sort/SortRemote.tsx" github="https://github.com/ja-plus/stk-table-react/tree/master/docs-demo/basic/sort/SortRemote.tsx"></demo>
...
<demo react="basic/sort/MultiSort.tsx" github="https://github.com/ja-plus/stk-table-react/tree/master/docs-demo/basic/sort/MultiSort.tsx"></demo>
...
type SortConfig<T extends Record<string, any>> = {
    ...
    defaultSort?: {
        ...
        /** Whether to disable triggering onSortChange event, default false */
        silent?: boolean;
    };
...
| defaultSort.silent | `boolean` | `false` | Whether to disable triggering `onSortChange` event. |
