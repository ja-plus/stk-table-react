...
StkTableReact does not have a built-in context menu, so you need to integrate a third-party library.
...
<demo react="other/contextmenu/ContextMenu.tsx" github="https://github.com/ja-plus/stk-table-react/tree/master/docs-demo/other/contextmenu/ContextMenu.tsx"></demo>
