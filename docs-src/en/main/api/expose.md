 ...
 * @param {boolean} option.silent Set to true to not trigger `onCurrentChange`. Default: false
 ...
 * @param option.silent Set to true to not trigger `onCurrentChange`. Default: false
 */
 ...
 * @param data.silent Set to true to not trigger `onToggleRowExpand`. Default: false
 */
 ...
 * @param option.silent Set to true to not trigger `onAreaSelectionChange`. Default: false
 ...
 * @param option.silent Set to true to not trigger `onFilterChange` event, default false
 */
