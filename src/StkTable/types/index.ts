...
export type StkTableProps<DT extends Record<string, any> = any> = {
    ...
    onRowClick?: (ev: React.MouseEvent, row: DT, data: { rowIndex: number }) => void;
    onCurrentChange?: (ev: React.MouseEvent | null, row: DT | undefined, data: { select: boolean }) => void;
    onCellSelected?: (ev: React.MouseEvent | null, data: { select: boolean; row: DT | undefined; col: StkTableColumn<DT> | undefined }) => void;
    onRowDblclick?: (ev: React.MouseEvent, row: DT, data: { rowIndex: number }) => void;
    onHeaderRowMenu?: (ev: React.MouseEvent) => void;
    onRowMenu?: (ev: React.MouseEvent, row: DT, data: { rowIndex: number }) => void;
    onCellClick?: (ev: React.MouseEvent, row: DT, col: StkTableColumn<DT>, data: { rowIndex: number }) => void;
    ...
    onCellMousedown?: (ev: React.MouseEvent, row: DT, col: StkTableColumn<DT>, data: { rowIndex: number }) => void;
...
export type StkTableRef<DT extends Record<string, any> = any> = {
    ...
    getSortColumns: () => { key: keyof DT | undefined; order: Order }[];
    ...
    setTreeExpand: (row: any, option?: { expand?: boolean }) => void;
    getSelectedArea: () => any;
